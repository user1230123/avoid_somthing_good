...
class MainMenuScene(Scene):
    def __init__(self, screen: pygame.Surface):
        self.title = GameObject((420, 170), (800, 300), pygame.image.load("assets/title.png"), colors.BLACK)
        self.playbutton = GameObject((300, 420), (500, 170), pygame.image.load("assets/playbutton.png"), colors.BLACK)
