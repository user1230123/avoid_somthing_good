...
from scenes import menu, physics_test
...
scenes: list[Type[Scene]] = [menu.MainMenuScene, physics_test.TestPhysicsScene]
scene_manager: SceneManager = SceneManager(screen, scenes)

# 초기 Scene 설정
scene_manager.add_scene_to_render('TestPhysicsScene')
